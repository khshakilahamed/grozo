                                    ...
                                    <AnimatePresence>
                                          {
                                                ...
                                                >
                                                      ...
                                                      <div className="mt-4 sm:mt-0 sm:ml-4 flex-1 text-center sm:text-left">
                                                            <h2 className="text-base sm:text-lg font-semibold text-gray-800 line-clamp-1">{item.name}</h2>
                                                      ...
                                                      <button className="sm:ml-4 mt-3 sm:mt-0 text-red-500 hover:text-red-700" onClick={() => dispatch(removeFromCart(item?._id!!))}>
                                                            <Trash2 />
                                                      </button>
