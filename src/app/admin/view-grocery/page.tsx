                  ...
                  <div className="space-y-4">
                        {
                              groceries?.map((g, i) => (
                                    ...
                                    >
                                          <div className="relative w-full sm:w-44 aspect-square rounded-xl overflow-hidden border border-gray-20">
                                                <Image
                                                      src={g.image}
                                                      alt={g.name}
                                                      fill
                                                ...
                                                <div className="max-h-[80vh] overflow-y-scroll">
                                                      ...
                                                      <div className="space-y-4">
                                                            <input
                                                                  ...
                                                                  value={editing?.name}
                                                                  onChange={
                                                                        (e) => setEditing({ ...editing, name: e.target.value })
                                                                  }
                                                            />
                                                            ...
                                                            <input
                                                                  ...
                                                                  value={editing?.price}
                                                                  onChange={
                                                                        (e) => setEditing({ ...editing, price: e.target.value })
                                                                  }
                                                            />
                                                            <select
                                                                  className="w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2 focus:ring-green-500 outline-none bg-white"
                                                            ...
                                                            <div className="flex justify-end gap-3 mt-6">
                                                                  <button
                                                                        className="px-4 py-2 rounded-lg bg-green-600 text-white flex items-center justify-center gap-2 hover:bg-green-700 transition-all"
                                                                        onClick={handleEdit}
                                                                        disabled={editLoading || deleteLoading}
                                                                  >
                                                                        {
                                                                  ...
                                                                  <button
                                                                        ...
                                                                        disabled={editLoading || deleteLoading}
                                                                        onClick={() => handleDelete(editing?._id?.toString()!)}
                                                                  >
                                                                        {
                                                                              deleteLoading ?
                                                                                    <Loader size={14} className=" text-white animate-spin"
