...
const GroceryItemCard = ({ item }: { item: IGrocery }) => {
      return (
            <motion.div
                  ...
                  viewport={{ once: false, amount: 0.3 }} // amount for view on the screen
            ...
            >
                  ...
                  <div className="p-4 flex flex-col flex-1">
                        ...
                        <motion.button
                              whileTap={{ scale: 0.96 }}
                              className="mt-4 flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white rounded-full py-2 text-sm font-medium transition-all"><ShoppingCart /> Add to Cart</motion.button>
                  </div>
            </motion.div>
      );
};
