...
const CategorySlider = () => {
      ...
      return (
            <motion.div
                  ...
                  viewport={{ once: false, amount: 0.5 }} // amount for view on the screen
                  className='w-[90%] md:w-[80%0] mx-auto mt-10 relative'
            >
                  <h2 className='text-2xl md:text-3xl font-bold text-green-700 mb-6 text-center capitalize'> 🛒 Shop by category</h2>
                  {
                        showLeft && <button
                              onClick={() => scroll("left")}
