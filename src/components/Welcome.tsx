  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-100 to-white">
      ...
      >
        ...
        <h1 className="text-4xl md:tex-5xl font-extrabold text-green-700">
          Grozo
        </h1>
      </motion.div>
      ...
      >
        <ShoppingBasket className="w-24 h-24 text-green-600 drop-shadow-md" />
        <Bike className="w-24 h-24 text-orange-600 drop-shadow-md" />
      </motion.div>
